...
class ExerciseCreatePopup extends StatefulWidget {
  const ExerciseCreatePopup({Key? key}) : super(key: key);

  @override
  State<ExerciseCreatePopup> createState() => _ExerciseCreatePopupState();
}

class _ExerciseCreatePopupState extends State<ExerciseCreatePopup> {
          ...
          TextButton(
            onPressed: () async {
              ...
              if (newExercise.name.isNotEmpty) {
                await PumpPalDatabase.instance.createExercise(newExercise);
              }
